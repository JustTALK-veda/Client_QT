...
template <> constexpr inline auto VideoThread::qt_create_metaobjectdata<qt_meta_tag_ZN11VideoThreadE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'cropped'
        QtMocHelpers::SignalData<void(int, const QPixmap &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 }, { QMetaType::QPixmap, 4 },
        }}),
        // Signal 'fullFrame'
...
void VideoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->cropped((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QPixmap>>(_a[2]))); break;
        case 1: _t->fullFrame((*reinterpret_cast< std::add_pointer_t<QPixmap>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (VideoThread::*)(int , const QPixmap & )>(_a, &VideoThread::cropped, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (VideoThread::*)(const QPixmap & )>(_a, &VideoThread::fullFrame, 1))
            return;
    }
}
...
// SIGNAL 0
void VideoThread::cropped(int _t1, const QPixmap & _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void VideoThread::fullFrame(const QPixmap & _t1)
{
